...
const SCENE = {
  "01-scan": `A titanium iPhone 15 Pro floats at a slight tilt in a dark charcoal photo studio with a soft glow behind it and a deep shadow below it.`,
  "02-analyze": `A titanium iPhone 15 Pro stands almost upright, centered, in a dark charcoal photo studio with a soft spotlight glow behind it and a deep shadow below it.`,
  "03-choose": `A titanium iPhone 15 Pro leans at a slight angle in a dark charcoal photo studio with a soft glow behind it, a deep shadow below it, and a faint diagonal floor split in the lower right.`,
};
const SCREEN = {
...
const TAIL = `The phone sits in the upper two thirds of the frame; the bottom quarter of the image is empty dark backdrop with nothing in it — text will be added there later. No text, words, captions, logos, sparkles, stars or watermarks anywhere outside the phone screen. Portrait 4:5 aspect ratio, 1080×1350.`;
